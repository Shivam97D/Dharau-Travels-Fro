...
export function ChatPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-24 right-4 z-50 flex w-[calc(100vw-2rem)] max-w-sm flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-float md:right-6"
    >
      {/* Header */}
